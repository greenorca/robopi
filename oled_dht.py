...
def sensorenAbfrage():
 ...
 while dhtSensor_aktiv:
    ...
    time.sleep(10) # notwendige Pause von mindestens 2 Sekunden - siehe Spezifikation des verwendeten Sensors
...
font_b = ImageFont.load_default() # Wenn keine eigene Schrift vorhanden ist!!!! 
font_c = ImageFont.load_default() # Wenn keine eigene Schrift vorhanden ist!!!! 

font = ImageFont.truetype("font/DejaVuSansCondensed.ttf", 12) # Schriftart, Schriftgröße
font_b = ImageFont.truetype("font/DejaVuSansCondensed.ttf", 12)
font_c = ImageFont.truetype("font/DejaVuSansCondensed.ttf", 14)
